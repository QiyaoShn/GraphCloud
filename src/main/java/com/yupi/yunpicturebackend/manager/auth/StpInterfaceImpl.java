...
import com.yupi.yupicture.application.service.PictureApplicationervice;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    @Resource
    private PictureApplicationervice pictureApplicationervice;
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        if (spaceId == null) {
            ...
            Picture picture = pictureApplicationervice.lambdaQuery()
